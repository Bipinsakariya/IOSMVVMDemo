...
@IBDesignable open class KWVerificationCodeView: UIView {
  ...
  private let textFieldViewVerticalSpace: CGFloat = 6
    ...
    public func setUpCode() {
        self.textFieldViews[0].activate()
    }
  ...
  @IBInspectable public var textColor: UIColor = UIColor.darkText {
   ...
   @IBInspectable public var borderWidth: CGFloat = 0 {
       didSet {
           for textFieldView in textFieldViews {
               textFieldView.numberTextField.layer.borderWidth = borderWidth
           }
       }
   }
   
   @IBInspectable public var borderColor: UIColor = UIColor.darkText {
       didSet {
            for textFieldView in textFieldViews {
    ...
    @IBInspectable public var cornerRadius: CGFloat = 0 {
        didSet {
            for textFieldView in textFieldViews {
                textFieldView.numberTextField.layer.cornerRadius = cornerRadius
                textFieldView.numberTextField.layer.masksToBounds = cornerRadius > 0
            }
        }
    }
